...
namespace SEXiled.Example.Events
{
    ...
    internal sealed class PlayerHandler
    {
        ...
        /// <inheritdoc cref="SEXiled.Events.Handlers.Scp106.OnContaining(ContainingEventArgs)"/>
        public void OnContaining(ContainingEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} is being contained as SCP-106!");
        }

        /// <inheritdoc cref="SEXiled.Events.Handlers.Scp106.OnCreatingPortal(CreatingPortalEventArgs)"/>
        ...
        /// <inheritdoc cref="SEXiled.Events.Handlers.Player.OnJoined(JoinedEventArgs)"/>
        ...
        /// <inheritdoc cref="SEXiled.Events.Handlers.Player.OnUnlockingGenerator(UnlockingGeneratorEventArgs)"/>
        public void OnUnlockingGenerator(UnlockingGeneratorEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} is trying to unlock a generator in {ev.Player.CurrentRoom} room");
        }

        /// <inheritdoc cref="SEXiled.Events.Handlers.Player.OnDestroying(DestroyingEventArgs)"/>
        public void OnDestroying(DestroyingEventArgs ev)
        {
            Log.Info($"{ev.Player.Nickname} ({ev.Player.Role}) is leaving the server!");
        }

        /// <inheritdoc cref="SEXiled.Events.Handlers.Player.OnDying(DyingEventArgs)"/>
        public void OnDying(DyingEventArgs ev)
        {
            Log.Info($"{ev.Target.Nickname} ({ev.Target.Role}) is getting killed by {ev.Killer.Nickname} ({ev.Killer.Role})!");
        }

        /// <inheritdoc cref="SEXiled.Events.Handlers.Player.OnPreAuthenticating(PreAuthenticatingEventArgs)"/>
        ...
        /// <inheritdoc cref="SEXiled.Events.Handlers.Player.OnSpawning(SpawningEventArgs)"/>
        ...
        /// <inheritdoc cref="SEXiled.Events.Handlers.Player.OnHurting(HurtingEventArgs)"/>
