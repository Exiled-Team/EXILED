...
**Примечание**: Перед запуском установщика, убедитесь, что вы используете учетную запись которая запускает сервер, или у вас есть права администратора.
...
### Установка плагинов
Вот и все, EXILED теперь установлен, и должен запустится при следующей загрузке сервера. Обратите внимание, что сам по себе EXILED практически ничего не делает, поэтому вы можете скачать плагины с **[нашего сервера Discord](https://discord.gg/PyUkWTg)**
