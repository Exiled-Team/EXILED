// -----------------------------------------------------------------------
// <copyright file="Scp173BeingLooked.cs" company="SEXiled Team">
...
#pragma warning disable SA1313
    ...
    internal static class Scp173BeingLooked
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            //
            // if (player == null || (player.Role == RoleType.Tutorial && SEXiled.Events.Events.Instance.Config.CanTutorialBlockScp173)
            //   continue;
            newInstructions.InsertRange(index, new[]
            {
                ...
                new CodeInstruction(OpCodes.Call, PropertyGetter(typeof(SEXiled.Events.Events), nameof(Instance))),
