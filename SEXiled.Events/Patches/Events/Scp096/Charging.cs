// -----------------------------------------------------------------------
// <copyright file="Charging.cs" company="SEXiled Team">
    ...
    internal static class Charging
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            newInstructions.InsertRange(0, new[]
            {
                ...
                new CodeInstruction(OpCodes.Newobj, GetDeclaredConstructors(typeof(ChargingEventArgs))[0]),
                new CodeInstruction(OpCodes.Dup),
                new CodeInstruction(OpCodes.Call, Method(typeof(Handlers.Scp096), nameof(Handlers.Scp096.OnCharging))),
                new CodeInstruction(OpCodes.Callvirt, PropertyGetter(typeof(ChargingEventArgs), nameof(ChargingEventArgs.IsAllowed))),
