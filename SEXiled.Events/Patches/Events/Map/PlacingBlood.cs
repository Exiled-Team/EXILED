// -----------------------------------------------------------------------
// <copyright file="PlacingBlood.cs" company="SEXiled Team">
...
#pragma warning disable SA1118
    ...
    internal static class PlacingBlood
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            // if (!SEXiled.Events.Instance.Config.CanSpawnBlood)
            //     return;
            //
            ...
            newInstructions.InsertRange(0, new[]
            {
                ...
                new CodeInstruction(OpCodes.Callvirt, PropertyGetter(typeof(SEXiled.Events.Events), nameof(SEXiled.Events.Events.Config))),
