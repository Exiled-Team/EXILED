...
namespace EXILED
{
	public class EventPlugin : Plugin
	{
		...
		public static ExiledVersion Version = new ExiledVersion { Major = 1, Minor = 10, Patch = 5 };
		...
		public static bool DamageTypesPatchDisable;
		public static bool RagdollManagerGetCausePatchDisable;
		#endregion
