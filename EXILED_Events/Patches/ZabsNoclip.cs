...
namespace EXILED.Patches
{
	public class ZabsNoclip
	{
		...
		public static bool CheckAnticheatSafe(Vector3 pos) =>
			Physics.RaycastNonAlloc(pos, Vector3.up, AnticheatRaycastBuffer, 1.7f, FallDamage._staticGroundMask) == 0 &&
			Physics.RaycastNonAlloc(pos, Vector3.down, AnticheatRaycastBuffer, 1.7f, FallDamage._staticGroundMask) != 0;
