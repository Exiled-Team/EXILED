...
namespace EXILED.Patches
{
    ...
    public class CallRpcGainExpOverride
    {
        public static bool Prefix(Scp079PlayerScript __instance, ExpGainType type, RoleType details)
        {
            ...
            Events.InvokeScp079GainExperienceEvent(__instance.gameObject, type, ref allow, ref amount);

            if (allow && amount > 0 && NetworkServer.active)
            {
