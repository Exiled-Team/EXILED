...
namespace Exiled.Events.Handlers
{
    ...
    public static class Scp096
    {
        ...
        {
            StartPryingGate.InvokeSafely(ev);
        }
        ...
        {
            TryingNotToCry.InvokeSafely(ev);
        }
        ...
        public static void OnChargingPlayer(ChargingPlayerEventArgs ev)
        {
            ChargingPlayer.InvokeSafely(ev);
        }
    }
}
