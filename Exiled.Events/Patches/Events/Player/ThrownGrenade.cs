// -----------------------------------------------------------------------
// <copyright file="ThrownGrenade.cs" company="Exiled Team">
...
namespace Exiled.Events.Patches.Events.Player
{
    ...
    /// Adds the <see cref="Handlers.Player.ThrownGrenade"/> event.
    /// </summary>
    [HarmonyPatch(typeof(ThrowableItem), nameof(ThrowableItem.ServerThrow))]
    internal static class ThrownGrenade
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            newInstructions.InsertRange(index, new[]
            {
                ...
                new(OpCodes.Newobj, GetDeclaredConstructors(typeof(ThrownGrenadeEventArgs))[0]),

                // Handlers.Player.OnThrowingItem(ev);
                new(OpCodes.Call, Method(typeof(Handlers.Player), nameof(Handlers.Player.OnThrowingGrenade))),
            });
