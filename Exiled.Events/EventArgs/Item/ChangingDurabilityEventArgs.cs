...
namespace Exiled.Events.EventArgs.Item
{
    ...
    public class ChangingDurabilityEventArgs : IPlayerEvent, IDeniableEvent, IFirearmEvent
    {
        ...
        /// </param>
        /// <param name="oldDurability">
        ///     <inheritdoc cref="OldDurability" />
        /// </param>
        /// <param name="newDurability">
        ///     <inheritdoc cref="NewDurability" />
        /// </param>
        /// <param name="isAllowed">
        ///     <inheritdoc cref="IsAllowed" />
        /// </param>
        public ChangingDurabilityEventArgs(Player player, ItemBase firearm, byte oldDurability, byte newDurability, bool isAllowed = true)
        {
