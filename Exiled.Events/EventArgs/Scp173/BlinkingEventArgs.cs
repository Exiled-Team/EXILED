...
namespace Exiled.Events.EventArgs.Scp173
{
    ...
    public class BlinkingEventArgs : IPlayerEvent, IDeniableEvent
    {
        ...
        public BlinkingEventArgs(Player player, List<Player> targets, Vector3 blinkPos)
        {
            ...
            Targets = targets;
            BlinkCooldown = Mathf.Max(PlayableScps.Scp173.BlinkCooldownBaseline, PlayableScps.Scp173.BlinkCooldownBaseline + (PlayableScps.Scp173.BlinkCooldownPerObserver * targets.Count));
        }
