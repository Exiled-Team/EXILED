...
namespace Exiled.Events.EventArgs.Player
{
    ...
    public class StoppingGeneratorEventArgs : ActivatingGeneratorEventArgs
    {
        ...
        /// </summary>
        /// <param name="player">The player who's fliping the switch.</param>
        /// <param name="generator">The <see cref="Scp079Generator" /> instance.</param>
        /// <param name="isAllowed">Indicates whether or not the switch of the generator can be fliped.</param>
