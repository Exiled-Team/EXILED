// -----------------------------------------------------------------------
// <copyright file="ThrownGrenadeEventArgs.cs" company="Exiled Team">
...
namespace Exiled.Events.EventArgs.Player
{
    ...
    /// </summary>
    public class ThrownGrenadeEventArgs : IPlayerEvent
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThrownGrenadeEventArgs"/> class.
        /// </summary>
        /// <param name="player"><inheritdoc cref="Player"/></param>
        /// <param name="item"><inheritdoc cref="Throwable"/></param>
        /// <param name="projectile"><inheritdoc cref="Projectile"/></param>
        public ThrownGrenadeEventArgs(Player player, ThrowableItem item, ThrownProjectile projectile)
        {
            Player = player;
