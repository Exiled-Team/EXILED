...
#pragma warning disable SA1118
    ...
    internal static class EscapingAndFailingEscapePocketDimension
    {
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            var exiledPlayerLocal = generator.DeclareLocal(typeof(API.Features.Player));
            ...
            newInstructions.InsertRange(index, new[]
            {
                ...
                new CodeInstruction(OpCodes.Newobj, Constructor(typeof(FailingEscapePocketDimensionEventArgs), new[] { typeof(API.Features.Player), typeof(PocketDimensionTeleport), typeof(bool) })),
                new CodeInstruction(OpCodes.Dup),
            ...
            newInstructions.InsertRange(index, new[]
            {
                ...
                new CodeInstruction(OpCodes.Ldc_I4_1),
                new CodeInstruction(OpCodes.Newobj, Constructor(typeof(EscapingPocketDimensionEventArgs), new[] { typeof(API.Features.Player), typeof(Vector3), typeof(bool) })),
                new CodeInstruction(OpCodes.Dup),
                new CodeInstruction(OpCodes.Dup),
