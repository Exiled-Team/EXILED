...
#pragma warning disable SA1118 // Parameter should not span multiple lines
    ...
    internal static class UsedMedicalItem
    {
        ...
        internal static void Patch()
        {
            ...
            Sexiled.Events.Events.Instance.Harmony.Patch(method, transpiler: PatchMethod);
        }
        ...
        internal static void Unpatch()
        {
            if (type != null && method != null)
            {
                Sexiled.Events.Events.Instance.Harmony.Unpatch(method, PatchMethod.method);
        ...
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            newInstructions.InsertRange(++index, new[]
            {
                ...
                new CodeInstruction(OpCodes.Newobj, AccessTools.Constructor(typeof(UsedMedicalItemEventArgs), new[] { typeof(API.Features.Player), typeof(ItemType) })),
