...
#pragma warning disable CS1570 // XML comment has badly formed XML
    ...
    ///         brtrue => Label13
    ///         ldloc.3
    ///         call static Sexiled.API.Features.Player Sexiled.API.Features.Player::Get(ReferenceHub referenceHub)
    ///         ldloc.2
    ///         call static Sexiled.API.Features.Player Sexiled.API.Features.Player::Get(ReferenceHub referenceHub)
    ///         ldarg.s 2
    ///         ldc.i4.1
    ///         newobj System.Void Sexiled.Events.EventArgs.LocalReportingEventArgs::.ctor(Sexiled.API.Features.Player issuer, Sexiled.API.Features.Player target, System.String reason, System.Boolean isAllowed)
    ///         dup
    ///         stloc.s 5
    ///         call static System.Void Sexiled.Events.Handlers.Server::OnLocalReporting(Sexiled.Events.EventArgs.LocalReportingEventArgs ev)
    ///         ldloc.s 5
    ///         ldloc.0
    ///         ldflda System.String<>c__DisplayClass14_0::reason
    ///         call static System.Void Sexiled.Events.Patches.Events.Server.LocalReporting::SuperReasonReplacer(Sexiled.Events.EventArgs.LocalReportingEventArgs ev, ref System.String reason)
    ///         ldloc.s 5
    ///         ldarga.s 2
    ///         call static System.Void Sexiled.Events.Patches.Events.Server.LocalReporting::SuperReasonReplacer(Sexiled.Events.EventArgs.LocalReportingEventArgs ev, ref System.String reason)
    ///         ldloc.s 5
    ///         call System.String Sexiled.Events.EventArgs.LocalReportingEventArgs::get_Reason()
    ///         ldc.i4.1
    ///         call static System.Void Sexiled.API.Features.Log::Debug(System.Object message, System.Boolean canBeSent)
    ///         ldloc.0
    ...
    ///         call static System.Void Sexiled.API.Features.Log::Debug(System.Object message, System.Boolean canBeSent)
    ///         ldloc.s 5
    ///         call System.Boolean Sexiled.Events.EventArgs.LocalReportingEventArgs::get_IsAllowed()
    ///         brtrue => Label17
    ///         br => Label27
    ///         Label17
    ///     </code>
    ...
    ///             Sexiled.Events.Server.OnLocalReporting(ev);
    ///             Sexiled.Events.Patches.Events.Server.LocalReporting.SuperReasonReplacer(ev, ref reason); // nested type field
    ///             Sexiled.Events.Patches.Events.Server.LocalReporting.SuperReasonReplacer(ev, ref reason); // method arg
    ///             if (!ev.IsAllowed)
    ///                 return;
    ///         }
    ///     </code>
