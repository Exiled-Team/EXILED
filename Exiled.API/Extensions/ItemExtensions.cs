...
namespace Exiled.API.Extensions
{
    ...
    public static class ItemExtensions
    {
        ...
        /// <returns>Returns whether or not the <see cref="ItemType"/> is an ammo.</returns>
        ...
        /// <param name="checkMicro">Indicates whether or not the MicroHID item should be taken into account.</param>
        /// <returns>Returns whether or not the <see cref="ItemType"/> is a weapon.</returns>
        ...
        /// </summary>
        /// <param name="item">The <see cref="ItemType">weapon</see> to retrieve the maximum ammo of.</param>
        /// <returns>Returns the maximum ammo of the given weapon, or <c>0</c> for an invalid <see cref="ItemType"/>.</returns>
