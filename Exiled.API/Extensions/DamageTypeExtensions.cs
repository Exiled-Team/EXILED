...
namespace Exiled.API.Extensions
{
    ...
    public static class DamageTypeExtensions
    {
        ...
        private static readonly Dictionary<DeathTranslation, DamageType> TranslationConversionInternal = new()
        {
            ...
            { DeathTranslations.Scp096, DamageType.Scp096SlapLeft },
            { DeathTranslations.Scp096, DamageType.Scp096Charge },
            { DeathTranslations.Scp096, DamageType.Scp096Gate },
            ...
            { DeathTranslations.Scp939Lunge, DamageType.Scp939LungeSecondary },
