...
namespace Exiled.API.Extensions
{
    ...
    public static class CameraExtensions
    {
        ...
        private static readonly Dictionary<string, CameraType> NameToCameraType = new Dictionary<string, CameraType>
        {
            ...
            ["etrcp @ a"] = CameraType.HczBChkp, // For some reason, this one and the next three are backwards lol
            ["etrcp @ b"] = CameraType.HczAChkp,
            ["ex @ a"] = CameraType.LczBChkp,
            ["ex @ b"] = CameraType.LczAChkp,
            ["glassroom"] = CameraType.LczGlassRoom,
            ["greenhouse"] = CameraType.LczGreenhouse,
            ["lcz @ a"] = CameraType.LczALight,
            ["lcz @ b"] = CameraType.LczBLight,
            ...
            ["ez entrance"] = CameraType.HczChkpEz,
            ["hcz @ a"] = CameraType.LczAHeavy,
            ["hcz @ b"] = CameraType.LczBHeavy,
            ["hcz armory"] = CameraType.HczArmory,
            ["hcz entrance"] = CameraType.EzChkpHcz,
            ...
            ["scp-079 main cam"] = CameraType.Hcz079Interior,
