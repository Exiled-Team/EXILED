// -----------------------------------------------------------------------
// <copyright file="Scp2176Pickup.cs" company="Exiled Team">
...
namespace Exiled.API.Features.Pickups.Projectiles
{
    ...
    /// </summary>
    public class Scp2176Pickup : EffectGrenadePickup
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Scp2176Pickup"/> class.
        /// </summary>
        /// <param name="pickupBase">The base <see cref="Scp2176Projectile"/> class.</param>
        public Scp2176Pickup(Scp2176Projectile pickupBase)
            : base(pickupBase)
        {
            Base = pickupBase;
        }
        ...
        /// </summary>
        public new Scp2176Projectile Base { get; }
