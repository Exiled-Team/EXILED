...
namespace Exiled.API.Features
{
    ...
    public class Effect
    {
        ...
        /// <param name="enable">Whether or not the effect should be enabled.</param>
        public Effect(EffectType type, float duration, byte intensity = 1, bool addDurationIfActive = false, bool enable = true)
        {
            Type = type;
            Duration = duration;
            Intensity = intensity;
