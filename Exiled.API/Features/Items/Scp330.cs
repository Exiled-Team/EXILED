...
namespace Exiled.API.Features.Items
{
    ...
    public partial class Scp330 : Usable
    {
        ...
        /// <param name="exposedType">The <see cref="CandyKindID"/> exposed type to use for this candy bag.</param>
        ...
        public Pickup Spawn(Vector3 position, Quaternion rotation = default, CandyKindID exposedType = CandyKindID.None)
        {
