        ...
        public float StaminaUseMultiplier
        {
            ...
            set
            {
                if (value is > 2f or < 1f)
                    throw new ArgumentOutOfRangeException(nameof(StaminaUseMultiplier), "Value of stamina use multiplier must be between 1f and 2f.");
        ...
        public float MovementSpeedMultiplier
        {
            ...
            set
            {
                if (value is < 0.0f or > 1f)
                    throw new ArgumentOutOfRangeException(nameof(MovementSpeedMultiplier), "Value of movement speed multiplier must be between 0 and 1.");
