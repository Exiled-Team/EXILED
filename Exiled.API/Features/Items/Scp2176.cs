...
namespace Exiled.API.Features.Items
{
    ...
    public class Scp2176 : Throwable
    {
        ...
        internal Scp2176(Player player = null)
            : this(player is null ? (ThrowableItem)Server.Host.Inventory.CreateItemInstance(new(ItemType.SCP2176, ItemSerialGenerator.GenerateNext()), false) : (ThrowableItem)player.Inventory.CreateItemInstance(new(ItemType.SCP2176, ItemSerialGenerator.GenerateNext()), true))
        {
        }
