...
namespace Exiled.API.Features.Scp914Processors
{
    ...
    /// <summary>
    /// A wrapper class for SCP-914 item processor for most of items.
    /// </summary>
    public class StandardProcessor : Scp914Processor, IWrapper<StandardItemProcessor>
    {
        ...
        public ItemType GetRandomOutput(Scp914KnobSetting knobSetting, ItemType previousItem) => Base.RandomOutput(knobSetting, previousItem);
