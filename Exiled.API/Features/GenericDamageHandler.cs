...
namespace Exiled.API.Features
{
    ...
    internal class GenericDamageHandler : PlayerStatsSystem.CustomReasonDamageHandler
    {
            ...
            : base($"You were damaged by {damageType}")
        {
            ...
            switch(damageType)
            {
                ...
                case DamageType.SeveredHands:
                    Base = new CustomReasonDamageHandler($"You were damaged by {damageType}", amount, cassieAnnouncement.Announcement);
                    break;
                ...
                case DamageType.Firearm:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GunAK);
                    break;
                case DamageType.MicroHid:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.MicroHID);
                    break;
                case DamageType.Explosion:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GrenadeHE);
                    break;
                case DamageType.Crossvec:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GunCrossvec);
                    break;
                case DamageType.Logicer:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GunLogicer);
                    break;
                case DamageType.Revolver:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GunRevolver);
                    break;
                case DamageType.Shotgun:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GunShotgun);
                    break;
                case DamageType.AK:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GunAK);
                    break;
                case DamageType.Com15:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GunCOM15);
                    break;
                case DamageType.Com18:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GunCOM18);
                    break;
                case DamageType.Fsp9:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GunFSP9);
                    break;
                case DamageType.E11Sr:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.GunE11SR);
                    break;
                case DamageType.ParticleDisruptor:
                    GenericFirearm(player, attacker, amount, damageType, ItemType.ParticleDisruptor);
                    break;
                ...
                case DamageType.Scp096:
                    ...
                    Base = new Scp096DamageHandler(curr096, amount, Scp096DamageHandler.AttackType.Slap);
                    break;
                case DamageType.Scp:
                ...
                case DamageType.Scp106:
                    Base = new ScpDamageHandler(attacker.ReferenceHub, amount, DeathTranslations.Unknown);
                    break;
                case DamageType.Custom:
                case DamageType.Unknown:
                default:
                    Base = new CustomReasonDamageHandler($"You were damaged by {damageType}", amount, $"{player.Nickname} killed by {attacker.Nickname} utilizing {damageType}");
                    break;
            }
        }
        ...
        {
            return base.ApplyDamage(ply);          // return base.ApplyDamage(ply);
        }
