...
#pragma warning restore SA1401
        ...
        {
            get => VoiceChatMutes.Mutes.Contains("ICOM-" + UserId) && (VoiceChatMuteFlags.HasFlag(VcMuteFlags.GlobalIntercom) || VoiceChatMuteFlags.HasFlag(VcMuteFlags.LocalIntercom));
            set
            {
                if (value)
