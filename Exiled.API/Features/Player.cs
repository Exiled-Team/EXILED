...
#pragma warning restore SA1401
        ...
        /// <returns> Whether all roles were removed from FriendlyFire rules successfully.</returns>
        ...
        /// <param name="destroy">Whether to destroy the item.</param>
        /// <param name="removeAll">Whether to remove all items of the specified <see cref="ItemType"/>.</param>
        ...
        /// <param name="addDuration">Whether to add the duration..</param>
        ...
        /// <param name="addDuration">Whether to add the duration on top.</param>
