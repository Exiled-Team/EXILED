// -----------------------------------------------------------------------
// <copyright file="ChangingScp914KnobSettingEventArgs.cs" company="Exiled Team">
...
namespace Exiled.Events.Handlers.EventArgs
{
    ...
    /// </summary>
    public class ChangingScp914KnobSettingEventArgs : EventArgs
    {
        private Scp914Knob knobSetting;

        /// <summary>
        /// Initializes a new instance of the <see cref="ChangingScp914KnobSettingEventArgs"/> class.
        /// </summary>
        /// <param name="player"><inheritdoc cref="Player"/></param>
        /// <param name="knobSetting"><inheritdoc cref="KnobSetting"/></param>
        /// <param name="isAllowed"><inheritdoc cref="IsAllowed"/></param>
        public ChangingScp914KnobSettingEventArgs(Player player, Scp914Knob knobSetting, bool isAllowed = true)
        {
            Player = player;
