// -----------------------------------------------------------------------
// <copyright file="SmartClassPicker.cs" company="Exiled Team">
...
namespace Exiled.Events.Patches.Fixes
{
    ...
    /// <summary>
    /// Patches <see cref="CharacterClassManager.RunSmartClassPicker"/>.
    /// </summary>
    [HarmonyPatch(typeof(CharacterClassManager), nameof(CharacterClassManager.RunSmartClassPicker))]
    public class SmartClassPicker
    {
        /// <summary>
        /// Fix the <see cref="CharacterClassManager.RunSmartClassPicker"/> method.
        /// </summary>
        /// <param name="__instance">The <see cref="CharacterClassManager"/> instance.</param>
        /// <returns>Returns a value indicating whether the original method should be executed or not.</returns>
        public static bool Prefix(CharacterClassManager __instance)
        {
            try
            {
                ...
                int r = PluginManager.Random.Next(1, 100);
                ...
                for (int i = 0; i < array.Length; i++)
                {
                    ...
                    ServerLogs.AddLog(
                        ...
                        string.Concat(
                            array[i].GetComponent<NicknameSync>().MyNick,
                            " (",
                            array[i].GetComponent<CharacterClassManager>().UserId,
                            ") spawned as ",
                ...
                if (ConfigFile.ServerConfig.GetBool("smart_class_picker", true))
                {
                    ...
                    try
                    {
                        ...
                        foreach (GameObject gameObject in shuffledPlayerList)
                        {
                            if (!(gameObject == null))
                            {
                                ...
                                {
                                    string str4 = (networkConnection != null) ? networkConnection.address : string.Empty;
                                    string str2 = (component != null) ? component.UserId : string.Empty;
                        ...
                        foreach (GameObject gameObject3 in shuffledPlayerList)
                        {
                            if (!(gameObject3 == null))
                            {
                                ...
                                string str5 = (networkConnection2 != null) ? networkConnection2.address : string.Empty;
                                string str3 = (component2 != null) ? component2.UserId : string.Empty;
                    ...
                    {
                        Console.AddLog(
                            "Smart Class Picker Failed: " + str + ", " + ex.Message,
