...
namespace SEXiled.API.Features
{
    ...
    using CustomFirearmHandler = SEXiled.API.Features.DamageHandlers.FirearmDamageHandler;

    using CustomHandlerBase = SEXiled.API.Features.DamageHandlers.DamageHandlerBase;
