// -----------------------------------------------------------------------
// <copyright file="ConfigManager.cs" company="SEXiled Team">
...
namespace SEXiled.Loader
{
    ...
    public static class ConfigManager
    {
        ...
        public static void LoadLoaderConfigs()
        {
            ...
            {
                Log.Error("SEXiled.Loader configs could not be loaded, some of them are in a wrong format, default configs will be loaded instead!");
                Log.Error(e);
            }
        }
