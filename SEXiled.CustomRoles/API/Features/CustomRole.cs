// -----------------------------------------------------------------------
// <copyright file="CustomRole.cs" company="SEXiled Team">
...
namespace SEXiled.CustomRoles.API.Features
{
    ...
    public abstract class CustomRole
    {
        ...
        protected virtual void SubscribeEvents()
        {
            ...
            SEXiled.Events.Handlers.Player.Dying += OnInternalDying;
        }
        ...
        private void OnInternalDying(DyingEventArgs ev)
        {
            if (Check(ev.Target))
            {
                ...
                SEXiled.API.Features.Ragdoll.Spawn(role, info, ev.Target.Position, Quaternion.Euler(ev.Target.Rotation), default, false, false);
                */
            }
        }
    }
