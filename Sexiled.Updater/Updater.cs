...
#pragma warning disable SA1300 // Element should begin with upper-case letter
    ...
    public sealed class Updater : Plugin<Config>
    {
        ...
        public static readonly string InstallerAssetNameLinux = "Sexiled.Installer-Linux";
        public static readonly string InstallerAssetNameWin = "Sexiled.Installer-Win.exe";
        ...
        public override void OnEnabled()
        {
            ...
            if (!_firstLaunch)
            {
                Log.Info("Sexiled won't be checked for an update because that's not the first launch of the plugin");
                return;
            }
        ...
        private HttpClient CreateHttpClient()
        {
            ...
            client.DefaultRequestHeaders.Add("User-Agent", $"Sexiled.Updater (https://github.com/galaxy119/EXILED, {Assembly.GetName().Version.ToString(3)})");
        ...
        private bool FindUpdate(HttpClient client, bool forced, out NewVersion newVersion)
        {
            try
            {
                var smallestVersion = FindSmallestSexiledVersion();
        ...
        private bool FindRelease(TaggedRelease[] releases, out Release release, SexiledLibrary smallestVersion, bool forced = false)
        {
            var includePRE = Config.ShouldDownloadTestingReleases || OneOfSexiledIsPrerelease();
        ...
        private SexiledLibrary FindSmallestSexiledVersion() => GetSexiledLibs().Min();

        private bool OneOfSexiledIsPrerelease() => GetSexiledLibs().Any(l => l.Version.PreRelease != null);

        private IEnumerable<SexiledLibrary> GetSexiledLibs()
        {
