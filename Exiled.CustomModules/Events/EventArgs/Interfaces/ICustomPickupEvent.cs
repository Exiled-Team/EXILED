// -----------------------------------------------------------------------
// <copyright file="ICustomPickupEvent.cs" company="Exiled Team">
...
namespace Exiled.CustomModules.Events.EventArgs.CustomItems
{
    ...
    /// <summary>
    /// Represents a marker interface used for all <see cref="API.Features.CustomItems.CustomItem"/> pickup related events.
    /// </summary>
    public interface ICustomPickupEvent : IPickupEvent
    {
        /// <summary>
